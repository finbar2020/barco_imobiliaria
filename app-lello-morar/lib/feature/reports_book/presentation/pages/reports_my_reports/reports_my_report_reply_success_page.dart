...
class MyReportReplySuccessPageArg {
  final ReportsController controller;

  MyReportReplySuccessPageArg({required this.controller});
}

class MyReportReplySuccessPage extends StatefulWidget {
  const MyReportReplySuccessPage({Key? key}) : super(key: key);

  @override
  _MyReportReplySuccessPageState createState() =>
      _MyReportReplySuccessPageState();
}

class _MyReportReplySuccessPageState extends State<MyReportReplySuccessPage> {
  @override
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    final SessionBloc sessionBloc = BlocProvider.of(context);
    MyReportReplySuccessPageArg arguments = ModalRoute.of(context)!
        .settings
        .arguments as MyReportReplySuccessPageArg;
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  ...
                  Navigator.popAndPushNamed(
                      context, ApplicationRoute.registerNewReport,
