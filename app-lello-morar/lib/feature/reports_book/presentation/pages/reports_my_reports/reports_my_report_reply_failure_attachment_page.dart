...
class MyReportReplyFailureAttachmentPageArg {
  final ReportsController controller;
  final Report report;
  final ReportContents content;
  final File attachment;

  MyReportReplyFailureAttachmentPageArg(
...
class MyReportReplyFailureAttachmentPage extends StatefulWidget {
  const MyReportReplyFailureAttachmentPage({Key? key}) : super(key: key);

  @override
  _MyReportReplyFailureAttachmentPageState createState() =>
      _MyReportReplyFailureAttachmentPageState();
}

class _MyReportReplyFailureAttachmentPageState
    extends State<MyReportReplyFailureAttachmentPage> {
  @override
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    final SessionBloc sessionBloc = BlocProvider.of(context);
    MyReportReplyFailureAttachmentPageArg arguments = ModalRoute.of(context)!
        .settings
        .arguments as MyReportReplyFailureAttachmentPageArg;
