...
final class _$PreferencesApi extends PreferencesApi {
  ...
  @override
  Future<Response<dynamic>> getPreferencesZeroPaper() {
    final Uri $url = Uri.parse('/me/preferences/zero-paper');
  ...
  @override
  Future<Response<dynamic>> putPreferencesZeroPaper(PreferencesModel body) {
    final Uri $url = Uri.parse('/me/preferences/zero-paper');
    final $body = body;
    final Request $request = Request(
      'PUT',
