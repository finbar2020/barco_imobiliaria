...
class AccessControlDeleteVisitDialog extends StatelessWidget {
  final SessionBloc sessionBloc;
  final VoidCallback onTap;
  const AccessControlDeleteVisitDialog({
    Key? key,
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: Dimens.spacingMedium),
            Text(
              getString(context, "access_control_deleted_visit_confirm"),
              textAlign: TextAlign.center,
