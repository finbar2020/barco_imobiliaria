...
class PhoneFormField extends FormField<String> {
  ...
  final bool enabled;
  final Validator? widgetValidator;
    ...
    return Row(
      ...
      children: [
        SizedBox(
          width: 60,
          child: TextFormField(
            validator: widget.widgetValidator?.validateRequired,
            focusNode: dddNode,
        ...
        Expanded(
          child: TextFormField(
            validator: widget.widgetValidator?.validateCellPhone,
            focusNode: phoneNode,
