...
import 'success_status_icon.dart';

class GenericSuccessBottomSheet extends StatelessWidget {
  final String message;
  final Widget? bottomActions;

  const GenericSuccessBottomSheet({
    super.key,
  ...
  static Future<T?> show<T>(
    ...
    return showModalBottomSheet<T>(
      ...
      builder: (_) => GenericSuccessBottomSheet(
        message: message,
