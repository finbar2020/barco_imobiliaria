...
import 'warning_status_icon.dart';

class GenericWarningBottomSheet extends StatelessWidget {
  final String message;
  final Widget? bottomActions;

  const GenericWarningBottomSheet({
    super.key,
  ...
  static Future<T?> show<T>(
    ...
    return showModalBottomSheet<T>(
      ...
      builder: (_) => GenericWarningBottomSheet(
        message: message,
