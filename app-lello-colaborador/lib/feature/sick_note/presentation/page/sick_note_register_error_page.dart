...
class SickNoteRegisterErrorPage extends StatelessWidget {
  const SickNoteRegisterErrorPage({Key? key}) : super(key: key);
          ...
          child: Center(
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(getString(context, "sick_note_register_error_title"),
                    textAlign: TextAlign.center,
                    style: LelloTextStyles.headline(theme)!.copyWith(
                      color: LelloTheme.palleteOf(theme).customColor(),
                    )),
                SizedBox(height: Dimens.spacing),
                Text(getString(context, "sick_note_register_error_subtitle"),
                    textAlign: TextAlign.center,
