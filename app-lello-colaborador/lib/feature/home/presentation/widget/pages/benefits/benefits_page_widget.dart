...
class BenefitsPageWidget extends StatefulWidget {
  const BenefitsPageWidget({Key? key}) : super(key: key);

  @override
  State<BenefitsPageWidget> createState() => _BenefitsPageWidgetState();
}

class _BenefitsPageWidgetState extends State<BenefitsPageWidget> {
  ...
  Widget _buildDashboard() {
    ...
    if (HomeItemEnum.discounts.checkVisible(sessionBloc)) {
      verifyCards.add(HomeItemEnum.discounts);
    }
    if (HomeItemEnum.indicateReceiveBenefits.checkVisible(sessionBloc)) {
      verifyCards.add(HomeItemEnum.indicateReceiveBenefits);
    }
    if (HomeItemEnum.condolivre.checkVisible(sessionBloc)) {
      verifyCards.add(HomeItemEnum.condolivre);
    }
    if (HomeItemEnum.employeeReferral.checkVisible(sessionBloc)) {
      verifyCards.add(HomeItemEnum.employeeReferral);
    }
