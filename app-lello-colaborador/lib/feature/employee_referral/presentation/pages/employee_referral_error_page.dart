...
class EmployeeReferralErrorPage extends StatelessWidget {
  const EmployeeReferralErrorPage({Key? key}) : super(key: key);
          ...
          child: Center(
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(getString(context, "employee_referral_erro_title"),
                    textAlign: TextAlign.center,
                    style: LelloTextStyles.headline(theme)!.copyWith(
                      color: LelloTheme.palleteOf(theme).customColor(),
                    )),
                SizedBox(height: Dimens.spacing),
                Text(getString(context, "employee_referral_erro_subtitle"),
                    textAlign: TextAlign.center,
