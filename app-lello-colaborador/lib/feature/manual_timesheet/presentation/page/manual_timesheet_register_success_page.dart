...
class ManualTimeSheetRegisterSuccessPage extends StatelessWidget {
  const ManualTimeSheetRegisterSuccessPage({Key? key}) : super(key: key);
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                    getString(
                      context,
                      "manual_timesheet_register_success_title_online",
                    ),
