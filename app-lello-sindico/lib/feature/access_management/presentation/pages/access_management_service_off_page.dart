...
class AccessManagerServiceOffPage extends StatefulWidget {
  const AccessManagerServiceOffPage({Key? key}) : super(key: key);

  @override
  State<AccessManagerServiceOffPage> createState() => _AccessManagerServiceOffPageState();
}

class _AccessManagerServiceOffPageState extends State<AccessManagerServiceOffPage> {
  @override
