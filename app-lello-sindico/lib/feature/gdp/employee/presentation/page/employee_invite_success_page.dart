...
class EmployeeInviteSuccessPage extends StatefulWidget {
  final EmployeeSendInviteSmsSuccessState state;
  const EmployeeInviteSuccessPage({
    Key? key,
    required this.state,
  }) : super(key: key);

  @override
  State<EmployeeInviteSuccessPage> createState() =>
      _EmployeeInviteSuccessPageState();
}

class _EmployeeInviteSuccessPageState extends State<EmployeeInviteSuccessPage> {
