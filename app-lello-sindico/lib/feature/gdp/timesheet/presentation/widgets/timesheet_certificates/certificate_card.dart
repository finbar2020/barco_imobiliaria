...
class CertificateCard extends StatelessWidget {
  final TimesheetOccurrenceCertificateEntity entity;
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                          getString(
                              context, "gdp_timesheet_certificate_init_date"),
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                          getString(
                              context, "gdp_timesheet_certificate_end_date"),
                          style: LelloTextStyles.subBody(theme)!.copyWith(
                              fontWeight: FontWeight.bold,
                              color: Colors.black)),
                      Flexible(
                  ...
                  if (entity.archiveHash.isNotEmpty)
                    SizedBox(height: Dimens.spacingSmall),
                  if (entity.archiveHash.isNotEmpty)
                    InkWell(
                      onTap: onTap,
                      child: Row(
                        ...
                        children: [
                          Text(
                              '${getString(context, "gdp_timesheet_certificate_title")}: ',
                              style: LelloTextStyles.subBody(theme)!.copyWith(
                                  fontWeight: FontWeight.bold,
                                  color: Colors.black)),
                          const Icon(
