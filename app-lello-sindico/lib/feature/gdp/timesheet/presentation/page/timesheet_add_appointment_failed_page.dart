...
class TimesheetAddAppointmentFailedPage extends StatelessWidget {
  final String? message;
  const TimesheetAddAppointmentFailedPage({Key? key, this.message})
      : super(key: key);
          ...
          child: Center(
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: Dimens.spacingLarge),
                Text(message ?? getString(context, "error_common_title"),
                    textAlign: TextAlign.center,
