...
class UnitDetailLinkSuccessPage extends StatefulWidget {
  final UnitDetailSendInviteLinkSuccessState state;
  const UnitDetailLinkSuccessPage({Key? key, required this.state})
      : super(key: key);

  @override
  State<UnitDetailLinkSuccessPage> createState() =>
      _UnitDetailLinkSuccessPageState();
}

class _UnitDetailLinkSuccessPageState extends State<UnitDetailLinkSuccessPage> {
