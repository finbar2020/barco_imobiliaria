...
class UnitDetailInviteSuccessPage extends StatefulWidget {
  final UnitDetailSendInviteSmsSuccessState state;
  const UnitDetailInviteSuccessPage({
    Key? key,
    required this.state,
  }) : super(key: key);

  @override
  State<UnitDetailInviteSuccessPage> createState() =>
      _UnitDetailInviteSuccessPageState();
}

class _UnitDetailInviteSuccessPageState
    extends State<UnitDetailInviteSuccessPage> {
