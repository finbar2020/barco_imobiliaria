...
class UnitDetailInviteErrorPage extends StatefulWidget {
  const UnitDetailInviteErrorPage({Key? key}) : super(key: key);

  @override
  State<UnitDetailInviteErrorPage> createState() =>
      _UnitDetailInviteErrorPageState();
}

class _UnitDetailInviteErrorPageState extends State<UnitDetailInviteErrorPage> {
  @override
