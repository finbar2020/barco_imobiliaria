...
class ReportsCloseReportSuccessPage extends StatelessWidget {
  @override
          ...
          child: Center(
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(getString(context, "reports_close_success"),
                    textAlign: TextAlign.center,
                    style: LelloTextStyles.headline(theme)!
                        .copyWith(color: Colors.white)),
                SizedBox(height: Dimens.spacingSmall),
                Text(getString(context, "reports_close_success_subtitle"),
                    textAlign: TextAlign.center,
