...
import 'package:lello/feature/accountability/data/model/acountability_grouped_account_model.dart';
...
class AccountabilityGroupedModel {
  ...
  double debits;
  double credits;
  List<AccountabilityGroupedAccaountModel> accounts;
  ...
  static AccountabilityGroupedModel fromEntity(AccountabilityGrouped entity) =>
      (AccountabilityGroupedModel(
        ...
        accounts: entity.accounts
            .map((e) => AccountabilityGroupedAccaountModel.fromEntity(e))
            .toList(),
      ));
