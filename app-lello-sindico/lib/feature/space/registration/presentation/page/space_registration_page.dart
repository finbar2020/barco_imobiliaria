...
class SpaceRegistrationPage extends StatefulWidget {
  const SpaceRegistrationPage({super.key});

  @override
  _SpaceRegistrationPageState createState() => _SpaceRegistrationPageState();
}

class _SpaceRegistrationPageState extends State<SpaceRegistrationPage> {
