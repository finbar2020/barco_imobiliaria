...
class ReservationChangeCalendarBlocImpl extends ReservationChangeCalendarBloc {
  ...
  @override
  Stream<ReservationChangeCalendarState> mapEventToState(
      ReservationChangeCalendarEvent event) async* {
    if (event is GetListUnitsEvent) yield* _mapGetListUnits(event);
  }

  Stream<ReservationChangeCalendarState> _mapGetListUnits(
      GetListUnitsEvent event) async* {
    yield ListUnitsLoadingState();
