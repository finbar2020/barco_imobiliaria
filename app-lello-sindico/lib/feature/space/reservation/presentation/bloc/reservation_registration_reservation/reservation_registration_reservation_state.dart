...
abstract class ReservationRegistrationReservationState extends Equatable {
  final ReservationRegistration? registration;
  final String? condominiumId;

  const ReservationRegistrationReservationState(
...
class ReservationRegistrationReservationLoadingState
  ...
  const ReservationRegistrationReservationLoadingState(
...
class ReservationRegistrationReservationLoadedState
  ...
  const ReservationRegistrationReservationLoadedState(
  ...
  @override
  List<Object?> get props => [registration, condominiumId, rule, units];
}
...
class ReservationRegistrationReservationLoadFailedState
  ...
  const ReservationRegistrationReservationLoadFailedState(
...
class ReservationRegistrationReservationRegisteringState
  ...
  const ReservationRegistrationReservationRegisteringState(
      ReservationRegistration registration,
      String condominiumId,
...
class ReservationRegistrationReservationRegisterFailedState
  ...
  const ReservationRegistrationReservationRegisterFailedState(
      ReservationRegistration registration,
      String condominiumId,
      ReservationRule rule,
      List<Unit> units,
  ...
  List<Object?> get props =>
      [registration, condominiumId, rule, units, error];
}
...
class ReservationRegistrationReservationRegisteredState
  ...
  const ReservationRegistrationReservationRegisteredState(
      this.reservation,
      ReservationRegistration registration,
      ReservationRule rule,
      List<Unit> units,
  ...
  @override
  List<Object?> get props =>
      [registration, condominiumId, rule, units, reservation];
}
