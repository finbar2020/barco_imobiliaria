...
part of 'task_by_asset_request_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TaskByAssetFiltersModel _$TaskByAssetFiltersModelFromJson(
        Map<String, dynamic> json) =>
    TaskByAssetFiltersModel(
...
Map<String, dynamic> _$TaskByAssetFiltersModelToJson(
        TaskByAssetFiltersModel instance) =>
    <String, dynamic>{
...
TaskByAssetRequestModel _$TaskByAssetRequestModelFromJson(
        Map<String, dynamic> json) =>
    TaskByAssetRequestModel(
      dtStart: json['dtStart'] as String,
      untilDate: json['untilDate'] as String,
      filters: json['filters'] == null
          ? null
          : TaskByAssetFiltersModel.fromJson(
              json['filters'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$TaskByAssetRequestModelToJson(
        TaskByAssetRequestModel instance) =>
    <String, dynamic>{
