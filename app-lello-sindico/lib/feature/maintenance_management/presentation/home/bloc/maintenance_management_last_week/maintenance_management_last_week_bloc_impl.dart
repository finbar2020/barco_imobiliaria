...
import 'maintenance_management_last_week_bloc.dart';
import 'maintenance_management_last_week_event.dart';
import 'maintenance_management_last_week_state.dart';

class MaintenanceManagementLastWeekBlocImpl
    extends MaintenanceManagementLastWeekBloc {
  final MaintenanceManagementRepository repository;

  MaintenanceManagementLastWeekBlocImpl(this.repository) {
