...
class LimitedJanitorCard extends StatefulWidget {
  const LimitedJanitorCard({super.key});

  @override
  State<LimitedJanitorCard> createState() => _LimitedJanitorCardState();
}

class _LimitedJanitorCardState extends State<LimitedJanitorCard> {
    ...
    return Card(
      child: ExpansionTile(
        ...
        title: Text(
          getString(
            context,
            "staff_access_management_limited_service_janitor",
          ),
