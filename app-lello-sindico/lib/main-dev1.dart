  ...
  try {
    ...
    if (!ApplicationContainer.instance().isInitialized) {
      await ApplicationContainer.instance()
          .setUp(DevelopmentProj1Environment());
    }
...
void main() async {
  ...
  try {
    if (!TTFirebaseApp.isAppInitialized('dev1_storage')) {
      await TTFirebaseApp.initializeSecondary(
        appName: 'dev1_storage',
    ...
    print('Firebase secundário (dev1_storage) já inicializado ou erro: $e');
  }
