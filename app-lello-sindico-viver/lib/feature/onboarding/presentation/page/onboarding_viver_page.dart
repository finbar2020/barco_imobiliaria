...
class OnBoardingViverPage extends StatefulWidget {
  @override
  _OnBoardingViverPageState createState() => _OnBoardingViverPageState();
}

class _OnBoardingViverPageState extends State<OnBoardingViverPage> {
